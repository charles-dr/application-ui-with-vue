...
<template>
  <div
    id="details"
    class="Section __lender-card Details mt-0 grid grid-cols-12 rounded-round bg-foreground_light p-6 dark:bg-foreground_dark"
  >
    <!-- left side -->
    <div
  ...
  <LenderContacts id="lender-contacnts" class="Section" /> -->
</template>
