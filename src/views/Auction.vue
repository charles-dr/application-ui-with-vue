...
<template>
  <div
    id="details"
    class="Section __vendor-card Details bg-foreground_light dark:bg-foreground_dark mt-0 grid grid-cols-12 rounded-round p-6"
  >
    <!-- left side -->
  ...
  <VehiclesAtAuction class="Section" />
  <VehiclesSold class="Section" />
  <Suspense>
    <template #default><VendorContacts class="Section" /></template>
