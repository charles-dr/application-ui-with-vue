...
<template>
  <div
    id="details"
    class="Section __vendor-card Details mt-0 grid grid-cols-12 rounded-round bg-foreground_light p-6 dark:bg-foreground_dark"
  >
    <!-- left side -->
  ...
  <VendorExpenses class="Section" id="expenses" />
  <VendorPayments class="Section" id="payments" />
  <VendorExpensesItems class="Section" id="expense-items" />
  <VendorContacts class="Section" />
</template>
