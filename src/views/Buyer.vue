...
<template>
  <div
    id="details"
    class="Section __vendor-card rounded-roundborder-2 mt-4 grid grid-cols-12 bg-white p-6 dark:border-0 dark:bg-foreground_dark"
  >
    <!-- left side -->
  ...
  <div class="mt-3 flex flex-col gap-y-3">
    <CommissionsPayed class="Section"  />
    <CommissionsPending class="Section" :buyer_id="routeParamId" />
    <VehiclesSold class="Section" :buyer_id="routeParamId" />
    <VehiclesPendingSale class="Section" />
  </div>
</template>
<style lang="scss">
#__subtabs[stuck],
