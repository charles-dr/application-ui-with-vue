...
<template>
  <TabGroup :selected-index="tabStore.selectedIndex" @change="tabChanged">
    <header
      class="z-80 relative h-[88px] pl-2 pr-[calc(0.5rem+5px)] pt-2 md:pl-6 md:pr-[calc(1.5rem+5px)] md:pt-6 !border-0"
    >
      <div
        class="Tabs relative flex h-[64px] items-center rounded bg-foreground_light dark:bg-foreground_dark"
      ...
      >
        ...
        <router-link
          ...
          :style="
            route.path == `/${props.pageName}`
              ? 'color: #007AFF'
              : `${global.isDark ? 'color: white' : 'color: black'}`
          "
        >
          <svg
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <tab
                      class="relative max-w-[175px] scroll-mr-3 focus:outline-none"
                      :class="[
        ...
        <div class="flex h-[48px]">
          <button
            class="grid w-8 place-content-center px-2 hover:text-primary"
          ...
          <button
            class="grid w-8 place-content-center px-1 hover:text-primary"
            v-if="showScrollArrow"
