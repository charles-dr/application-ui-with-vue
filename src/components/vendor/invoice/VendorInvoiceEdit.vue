...
watch(
  ...
  (newValue) => {
    if (newValue) {
      ...
      form.value.expenses =
        props.initialData.vendor_expenses?.map((expense) => ({
          ...pick(expense, [
            "deal",
            "deal_id",
            "description",
  ...
  >
    <n-form ref="formRef" :model="form" :rules="rules">
        ...
        <header class="flex content-center justify-between">
          ...
          <span class="text-sm font-bold">{{ initialData.due_date }}</span> -->
            ...
            <div class="text-right">
              ...
              <span class="text-sm font-bold">
                {{ current_vendor?.payment_terms?.name }}</span
              >
            </div>
          </section>
        </header>
      ...
      <main class="mt-4">
        ...
        <section
          class="mt-5 flex flex-col items-center justify-between gap-4 md:flex-row"
        >
          <div class="w-full">
            <n-input
              placeholder="Notes"
