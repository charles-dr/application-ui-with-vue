...
<template>
  <n-button
    class="Documents__action Documents__action--upload w-full mt-[24px] md:w-[220px] md:mt-[0px]"
    @click="handleDirectUpload"
    >Upload Media</n-button
  >
  <n-modal
  ...
  >
    ...
    <div id="DWTcontainer" class="grid grid-cols-3 gap-4">
      <div class="md:col-span-2 col-span-3">
        <n-upload :default-upload="false" @change="handleChange" :file-list="fileList">
          <n-upload-dragger>
      ...
      <div class="md:col-span-1 col-span-3">
        <n-card title="Save Documents" size="small" class="" v-if="!isDocTypeLoading">
          <n-form
            ref="saveFileFormRef"
            :label-width="80"
          ...
          >
            ...
            <n-form-item label="Description" path="description" class="col-span-3">
              <n-input
