...
<template>
  <div class="flex items-center justify-center gap-x-3">
    ...
    <!--   Delete Button -->
    <n-button v-if="showDeleteButton" @click="showDeleteModal = true">
      <n-icon>
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M1.00007 9.72795L9.72803 1" stroke="currentColor" stroke-width="2" />
          <path d="M9.72844 9.72795L1.00049 1" stroke="currentColor" stroke-width="2" />
        </svg>
      </n-icon>
    </n-button>
